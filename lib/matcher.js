...
function matcher(x, y, radius, opts, onJoin) {
        ...
        for (var subID in subs){
            ...
            if (sub.followClient === true){
                ...
                if (sub.aoi.isPolygon === false) {
                    _moveSubscription(sub, new VAST.pos(x,y));
                };
    ...
    var _subscribe = this.subscribe = function(clientID, area, channel) {
    ...
    var _moveSubscription = function(sub, new_pos){ // TODO: This is new, try and complete
        console.log('I am moving a subscription');
